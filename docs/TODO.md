...
* List of connected participants (panel that shows up when you click the "x user" button)
* Undo/redo of adding; removing
* Save deleted concepts in a scratch pile
* Avoid new nodes from gliding off (untethered)
